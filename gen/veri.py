...
def veri(stu):
	...
	stu_name = stu['name']
	barcode = reader.decode(f"C:/Users/Administrator/Desktop/Dome/static/ewm_img/{stu_name}.png")
...
#print(veri(sherry)) #html验证Scarlett这一个人就行了。因为网页上本来也是写的她的名字
def ma():
	a = veri(scarlett)
	return a
